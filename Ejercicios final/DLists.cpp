...
int main()
{
    ...
    cout << endl << "Push front sin frecuencia" << endl;
    ...
    for (int lIdx = 0; lIdx < 5; lIdx++) lLista.pop_front();
    lLista.repr();
    lLista.clean();

    cout << endl << "Push back sin frecuencia" << endl;
    lLista.push_back("uno");
    lLista.push_back("dos");
    lLista.push_back("tres");
    lLista.push_back("cuatro");
    lLista.push_back("cinco");
    lLista.push_back("uno");
    lLista.push_back("dos");
    lLista.push_back("tres");
    lLista.push_back("cuatro");
    ...
    for (int lIdx = 0; lIdx < 5; lIdx++) lLista.pop_back();
    lLista.repr();
    lLista.clean();

    cout << endl << "Push ordenado sin frecuencia" << endl;
    lLista.push("uno");
    lLista.push("dos");
    lLista.push("tres");
    lLista.push("cuatro");
    ...
    cout << endl << "Push front con frecuencia" << endl;
    lLista.push_front("uno");
    lLista.push_front("dos");
    lLista.push_front("tres");
    lLista.push_front("cuatro");
    ...
    cout << endl << "Push back con frecuencia" << endl;
    lLista.push_back("uno");
    lLista.push_back("dos");
    lLista.push_back("tres");
    lLista.push_back("cuatro");
    ...
    cout << endl << "Push ordenado con frecuencia" << endl;
    lLista.push("uno");
    lLista.push("dos");
    lLista.push("tres");
    lLista.push("cuatro");
